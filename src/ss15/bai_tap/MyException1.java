...
public class MyException1 {
    ...
    public static void check(int x, int y, int z) throws IllegalTriangleException {
        if (x <= 0 || y <= 0 || z <= 0) {
            throw new IllegalTriangleException("cạnh của tam giác phải lớn hơn 0 , vui lòng nhập lại");
        } else if (x + y < z || x + z < y || y + z < x) {
            throw new IllegalTriangleException(" không phải 3 cạnh của tam giác, vui lòng nhập lại");
        } else {
